...
| [003](sessions/003-richness-bat-tracking-and-timing-pause.md) | Sequencing richness, swing-timing side branch, bat-tracking features | Prev_2/3 richness and a raw bat-tracking feature bundle both tested and not adopted (noise-floor gains only); estimated-swing-timing side branch explored, validated, and paused after blinded review found a bunt/check-swing data-quality gap |
